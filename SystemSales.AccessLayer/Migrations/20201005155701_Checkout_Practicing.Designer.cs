...
namespace SystemSales.AccessLayer.Migrations
{
    ...
    [Migration("20201005155701_Checkout_Practicing")]
    partial class Checkout_Practicing
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SystemApp.Models.DataModels.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SystemApp.Models.DataModels.OrderDetail_Testing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("OrderDetail_Testings");
                });
            ...
            modelBuilder.Entity("SystemApp.Models.DataModels.OrderDetails", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("OrderDetails");
                });
            ...
            modelBuilder.Entity("SystemApp.Models.DataModels.Checkout", b =>
                {
                    b.HasBaseType("SystemApp.Models.DataModels.OrderDetails");

                    b.Property<string>("PaymentType")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ViaThirdParty")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SystemApp.Models.DataModels.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SystemApp.Models.DataModels.OrderDetail_Testing", b =>
                {
                    b.HasOne("SystemApp.Models.DataModels.Order", null)
            ...
            modelBuilder.Entity("SystemApp.Models.DataModels.OrderDetails", b =>
                {
                    b.HasOne("SystemApp.Models.DataModels.ApplicationUser", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("SystemApp.Models.DataModels.Product", b =>
                {
                    ...
                    b.HasOne("SystemApp.Models.DataModels.ApplicationUser", "ProductOwner")
                        .WithMany()
